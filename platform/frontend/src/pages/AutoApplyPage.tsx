            ...
            {needs.map((a) => (
              <li key={a.id}>
                ...
                >
                  ...
                  {(a.drafts_ready ?? 0) > 0 && (
                    <span className="shrink-0 rounded-full bg-blue-100 px-2 py-0.5 text-[11px] font-medium text-blue-800">
                      {a.drafts_ready === 1 ? "Draft ready" : `${a.drafts_ready} drafts ready`}
                    </span>
                  )}
