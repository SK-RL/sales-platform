...
_FIELD_ALIASES: dict[str, list[str]] = {
    ...
    "email": ["email", "email_address", "whats_your_email", "whats_your_email_address", "what_is_your_email_address", "what_is_your_email"],
    "phone": ["phone", "phone_number", "mobile", "whats_your_phone_number", "what_is_your_phone_number", "telephone", "mobile_number", "contact_number"],
    "linkedin_url": ["linkedin", "linkedin_url", "linkedin_profile", "linkedincom", "linkedin_link", "linkedin_profile_url", "what_is_your_linkedin_url", "linkedin_profile_link"],
    "website": ["website", "portfolio", "personal_website", "website_portfolio", "portfolio_url", "website_url", "personal_website_url"],
    "github": ["github", "github_url", "github_profile", "what_is_your_github_url", "github_link"],
